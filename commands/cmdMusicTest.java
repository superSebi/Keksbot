...
//
//        String pre = PrefixHandler.getUserPrefix(event.getAuthor().getId(), event.getGuild().getId());
//
...
//            if (guild.getTextChannelsByName("beste-musik", true).size() > 0) {
//                guild.getTextChannelsByName("beste-musik", true).get(0).getManager().setTopic(
//                        track.getInfo().title
//                ).queue();
//
...
//                    guild.getTextChannelsByName("beste-musik", true).get(0).sendMessage(
//                            eb.build()
//                    ).queue();
//                } catch (Exception e) {
//                }
...
//                if (guild.getTextChannelsByName("beste-musik", true).size() > 0)
//                    guild.getTextChannelsByName("beste-musik", true).get(0).sendMessage("Repeated queue. *(endless mode)*").queue();
//            }
//
